...
class TestRefreshToken(unittest.TestCase):
    ...
    def test_happy_path_no_resource(self):
        ...
        context.acquire_token_with_refresh_token(cp['refreshToken'], cp['clientId'], None, None, self._callback)
    ...
    def test_happy_path_with_resource(self):
        ...
        context = AuthenticationContext(cp['authorityTenant'])
        context.acquire_token_with_refresh_token(cp['refreshToken'], cp['clientId'], None, cp['resource'], self._callback)
    ...
    def test_happy_path_no_resource_client_secret(self):
        ...
        context = AuthenticationContext(cp['authorityTenant'])
        context.acquire_token_with_refresh_token(cp['refreshToken'], cp['clientId'], cp['clientSecret'], None, self._callback)
    ...
    def test_happy_path_with_resource_client_secret(self):
        ...
        context = AuthenticationContext(cp['authorityTenant'])
        context.acquire_token_with_refresh_token(cp['refreshToken'], cp['clientId'], cp['clientSecret'], cp['resource'], self._callback)  

    @httpretty.activate
    def test_happy_path_no_resource_legacy(self):
        tokenRequest = util.setup_expected_refresh_token_request_response(200, self.wire_response, self.response['authority'])
        context = AuthenticationContext(cp['authorityTenant'])
        context.acquire_token_with_refresh_token(cp['refreshToken'], cp['clientId'], None, self._callback) 

    @httpretty.activate
    def test_happy_path_with_resource_legacy(self):
        tokenRequest = util.setup_expected_refresh_token_request_response(200, self.wire_response, self.response['authority'], self.response['resource'])
        context = AuthenticationContext(cp['authorityTenant'])
        context.acquire_token_with_refresh_token(cp['refreshToken'], cp['clientId'], cp['resource'], self._callback) 
